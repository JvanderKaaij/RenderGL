...
- Depending on your configuration, in Windows you may need to init `emsdk/emsdk_env.bat` in your console to access the Emscripten command-line tools.
